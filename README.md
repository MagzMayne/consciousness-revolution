...
**Total Projects**: 2065 | **Interactive**: 1891

**Status Breakdown**:
- ✅ **1665 working** (81% - fully functional)
- ⚠️ **97 partial** (5% - core features work)
- 🔧 **75 broken** (4% - under repair)
- 🧪 **228 untested** (11% - awaiting validation)

**Top Categories**: ✨ web-app: 1497 | 🤖 ai-tool: 138 | 📊 dashboard: 129 | 🌐 3d-experience: 102 | 🛠️ utility: 73

**Top Technologies**: PayPal (896), Web Storage (527), Solana Web3 (202), Canvas (187), React (163)

*Last scanned: Mar 19, 2026, 11:52 PM*
...
1. ✨✅ **[Autonomous Agent Hub — zMerlin Hive (Enhanced)](zMerlinHive.html)** - Interactive web-app application `React`, `PayPal` *(Mar 19, 2026)*
2. ✨✅ **[User-Owned AI Voice Tool](yourVoice.html)** - Interactive web-app application `PayPal` *(Mar 19, 2026)*
3. 🤖✅ **[Worm Agent 3D Visualization](worm-agent-visualization.html)** - Interactive ai-tool application `Three.js`, `Canvas`, `WebGL` *(Mar 19, 2026)*
4. 🤖✅ **[Worm Agent System Dashboard](worm-agent-dashboard.html)** - Interactive ai-tool application `Canvas` *(Mar 19, 2026)*
5. ✨✅ **[WORKSPACE - Dashboard Hub](workspace.html)** - Interactive web-app application *(Mar 19, 2026)*
6. ✨✅ **[WORKSPACE - Dashboard Hub](workspace-v3.html)** - Interactive web-app application *(Mar 19, 2026)*
7. ✨⚠️ **[Workshop - Build Things](workshop.html)** - Interactive web-app application *(Mar 19, 2026)*
8. 🎮✅ **[Tourmaline Poker — 500 Seats (PMS UTC Sync)](workingPokerTable.html)** - Interactive game application `React`, `PayPal` *(Mar 19, 2026)*
9. ✨✅ **[Magical Wishing Well](wishingWell.html)** - Interactive web-app application `Three.js`, `PayPal`, `WebGL` *(Mar 19, 2026)*
10. 💰✅ **[Widget Marketplace | Consciousness Revolution](widget-marketplace.html)** - Interactive marketplace application `Web Storage` *(Mar 19, 2026)*

*Last updated: Mar 19, 2026, 11:52 PM*
