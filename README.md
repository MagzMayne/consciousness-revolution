...
**Total Projects**: 2093 | **Interactive**: 1917

**Status Breakdown**:
- ✅ **1685 working** (81% - fully functional)
- ⚠️ **99 partial** (5% - core features work)
- 🔧 **76 broken** (4% - under repair)
- 🧪 **233 untested** (11% - awaiting validation)

**Top Categories**: ✨ web-app: 1518 | 🤖 ai-tool: 140 | 📊 dashboard: 131 | 🌐 3d-experience: 103 | 🛠️ utility: 74

**Top Technologies**: PayPal (907), Web Storage (542), Solana Web3 (209), Canvas (188), React (167)

*Last scanned: Apr 1, 2026, 2:04 AM*
...
1. ✨✅ **[Autonomous Agent Hub — zMerlin Hive (Enhanced)](zMerlinHive.html)** - Interactive web-app application `React`, `PayPal` *(Apr 1, 2026)*
2. ✨✅ **[User-Owned AI Voice Tool](yourVoice.html)** - Interactive web-app application `PayPal` *(Apr 1, 2026)*
3. ✨✅ **[XP Transmutation Hub — Consciousness Revolution](xp-transmutation-hub.html)** - Convert your XP to real on-chain crypto tokens — OKK (Overkill Kulture) and RootIB (Root Idea Block) on Solana via pump.fun `Solana Web3`, `Web Storage` *(Apr 1, 2026)*
4. 🤖✅ **[Worm Agent 3D Visualization](worm-agent-visualization.html)** - Interactive ai-tool application `Three.js`, `Canvas`, `WebGL` *(Apr 1, 2026)*
5. 🤖✅ **[Worm Agent System Dashboard](worm-agent-dashboard.html)** - Interactive ai-tool application `Canvas` *(Apr 1, 2026)*
6. ✨✅ **[WORKSPACE - Dashboard Hub](workspace.html)** - Interactive web-app application *(Apr 1, 2026)*
7. ✨✅ **[WORKSPACE - Dashboard Hub](workspace-v3.html)** - Interactive web-app application *(Apr 1, 2026)*
8. ✨⚠️ **[Workshop - Build Things](workshop.html)** - Interactive web-app application *(Apr 1, 2026)*
9. 🎮✅ **[Tourmaline Poker — 500 Seats (PMS UTC Sync)](workingPokerTable.html)** - Interactive game application `React`, `PayPal` *(Apr 1, 2026)*
10. ✨✅ **[Magical Wishing Well](wishingWell.html)** - Interactive web-app application `Three.js`, `PayPal`, `WebGL` *(Apr 1, 2026)*

*Last updated: Apr 1, 2026, 2:04 AM*
