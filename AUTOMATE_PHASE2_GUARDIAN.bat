@echo off
REM PHASE 2 AUTOMATION - GUARDIAN.HTML STANDARDIZATION
REM C1 MECHANIC - Batch operation for speed

echo ========================================
echo PHASE 2: GUARDIAN.HTML STANDARDIZATION
echo ========================================
echo.
echo This script will:
echo 1. Backup current Guardian.html
...
copy Guardian.html Guardian.html.backup
echo ✓ Backup created: Guardian.html.backup
echo.
...
echo.
echo Action: Open Guardian.html in editor
echo        Copy ALL CSS from: standard_css_blocks.txt
echo        Paste after line 303
echo        Find-Replace: #e74c3c → #2ecc71
echo        Find-Replace: rgba(231, 76, 60 → rgba(46, 204, 113
echo.
pause
...
echo        See: SPEED_RUN_PHASE2_FORGE_STANDARDIZATION.md (Section 2B)
echo.
pause
...
echo        See: SPEED_RUN_PHASE2_FORGE_STANDARDIZATION.md (Section 2C)
echo.
pause
...
echo        See: SPEED_RUN_PHASE2_FORGE_STANDARDIZATION.md (Section 2D)
echo.
pause
...
echo ------------------------
echo Location: Lines 651-679
echo Action: Replace with tiered Free/Team/Personal structure
echo        See: SPEED_RUN_PHASE2_FORGE_STANDARDIZATION.md (Section 2E)
echo.
pause
