...
const DOMAIN_FORGE_MAP = {
  0: { domain: 'TRANSCEND',  forge: 'Infinity',  slug: 'infinity',  icon: '∞',  color: '#9400D3', chakra: 'Crown',     hz: 528 },
  1: { domain: 'COMMAND',    forge: 'Reality',   slug: 'reality',   icon: '🔥', color: '#FF0000', chakra: 'Root',      hz: 264 },
  2: { domain: 'BUILD',      forge: 'Creation',  slug: 'creation',  icon: '⚡', color: '#FF7F00', chakra: 'Sacral',    hz: 297 },
  3: { domain: 'PROTECT',    forge: 'Guardian',  slug: 'guardian',  icon: '🛡️', color: '#00FF00', chakra: 'Solar',     hz: 330 },
  4: { domain: 'CONNECT',    forge: 'Signal',    slug: 'signal',    icon: '📡', color: '#FFFF00', chakra: 'Heart',     hz: 352 },
  5: { domain: 'GROW',       forge: 'Wealth',    slug: 'wealth',    icon: '💰', color: '#0000FF', chakra: 'Throat',    hz: 396 },
  6: { domain: 'LEARN',      forge: 'Character', slug: 'character', icon: '👤', color: '#4B0082', chakra: 'Third Eye', hz: 444 }
};
...
const FORGE_DATA = {
  ...
  signal: { id: 4, name: "Signal Forge", slug: "signal", icon: "📡", domain: "CONNECT", domainNum: 4, color: "#FFFF00", gradient: "linear-gradient(135deg, #FFFF00 0%, #FFD700 100%)",
    frequency: 352, frequencyName: "Heart Bridge",
    tagline: "Connect and coordinate",
    dailyRitual: "Who did you truly connect with today?",
    lobbyMessage: "Connector, welcome.",
    unlockLevel: 7,
    navigationCards: [
      { id: "store", title: "Comms Tools", icon: "💎", description: "Amplify", route: "forge-store.html?forge=signal" },
      { id: "levels", title: "13 Phases", icon: "📊", description: "Connection", route: "forge-levels.html?forge=signal" },
      { id: "workshop", title: "Practice", icon: "💬", description: "Comms", route: "forge-workshop.html?forge=signal" },
      { id: "vault", title: "Connections", icon: "🏆", description: "Network", route: "forge-vault.html?forge=signal" }
    ]
  },
  guardian: { id: 3, name: "Guardian Forge", slug: "guardian", icon: "🛡️", domain: "PROTECT", domainNum: 3, color: "#00FF00", gradient: "linear-gradient(135deg, #00FF00 0%, #228B22 100%)",
    frequency: 330, frequencyName: "Solar Power",
  ...
  infinity: { id: 0, name: "Infinity Forge", slug: "infinity", icon: "∞", domain: "TRANSCEND", domainNum: 0, color: "#9400D3", gradient: "linear-gradient(135deg, #9400D3 0%, #4B0082 100%)",
