 ...
 * ═══════════════════════════════════════════════════════════════
 * What lives in each consciousness domain - for ARAYA to guide people
 *
 * LEVELS:
 * - free: Public access (consciousnessrevolution.io)
 * - team: Team access (100xbuilder.io inner spaceship)
 * - personal: Individual cockpits
 *
 * Pattern: 3 → 7 → 13 → ∞
 * ═══════════════════════════════════════════════════════════════
 */
...
// Find relevant tools based on what user is looking for
export function findDomainTools(message) {
...
// Format tools for ARAYA's response
export function formatDomainResponse(matches) {
    if (matches.length === 0) {
        return null;
    }
