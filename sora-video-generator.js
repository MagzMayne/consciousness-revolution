 ...
 * 
 * PATENT DECLARATION:
 * File: sora-video-generator.js
 * Declaration ID: IP-4BA94628-MLL28ZVW
 * Date: 2026-02-13
...
/** SIGNED BY MeRLynn - ID: MERLYNN-67eb081e - TIMESTAMP: 2025-12-19T05:53:06.531Z - HASH: 56a0c878 */
/** SIGNED BY AGentR - ID: AGENTR-451edb91 - TIMESTAMP: 2025-12-19T05:53:06.531Z - HASH: 56a0c878 */
...
class SoraVideoGenerator {
    ...
    generateMockDemo(title) {
        console.log('🎭 Generating video placeholder for:', title);
        ...
        const placeholder = {
            ...
            type: 'placeholder',
            message: 'Video generation requires API key. Use Community Pool or contribute your API key.'
        };

        this.generatedVideos.push(placeholder);
        localStorage.setItem('sora-generated-videos', JSON.stringify(this.generatedVideos));
        this.updateVideoGallery();

        alert(`⚠️ Video generation for "${title}" requires an API key.\n\nTo generate real AI videos:\n1. Use the Community Pool feature\n2. Contribute your own API key\n3. Contact the platform administrator`);
    }
